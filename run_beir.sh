...
# List of datasets
datasets=("beir_cqadupstack-physics" "beir_cqadupstack-programmers" "beir_cqadupstack-stats" "beir_cqadupstack-tex" "beir_cqadupstack-unix" "beir_cqadupstack-webmasters" "beir_cqadupstack-wordpress" "beir_dbpedia-entity" "beir_fever" "beir_fiqa" "beir_hotpotqa" "beir_nfcorpus" "beir_nq" "beir_quora" "beir_robust04" "beir_scidocs" "beir_scifact" "beir_trec-news")

# Reverse the order of the datasets array
datasets=($(echo "${datasets[@]}" | tac -s ' '))
