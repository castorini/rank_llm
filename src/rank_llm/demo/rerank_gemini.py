...
writer.write_in_jsonl_format("demo_outputs/rerank_results_gemini.jsonl")
writer.write_in_trec_eval_format("demo_outputs/rerank_results_gemini.txt")
writer.write_inference_invocations_history(
    "demo_outputs/inference_invocations_history_gemini.json"
)
